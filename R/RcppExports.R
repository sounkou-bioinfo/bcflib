...
ConvertSummaryStats <- function(inputFile, outputFile, columnsPreset, columnsFile, fastaRef, faiFile, sampleName, ns, nc, ne, outputType, writeIndex, threads, cacheSize, iffyTag, mismatchTag, recordCmdLine) {
    .Call(`_bcflib_ConvertSummaryStats`, inputFile, outputFile, columnsPreset, columnsFile, fastaRef, faiFile, sampleName, ns, nc, ne, outputType, writeIndex, threads, cacheSize, iffyTag, mismatchTag, recordCmdLine)
}
